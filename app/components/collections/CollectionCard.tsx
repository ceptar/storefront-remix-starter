...
export function CollectionCard({
  ...
  return (
    ...
    >
    <div className="inline-flex flex-col items-start gap-2 p-4 bg-discoteal-100 ">
      ...
      <div className="h-[2rem] flex flex-col items-start justify-start text-sm text-discogray font-metrolight1 leading-[140%] whitespace-normal">
      {collection.name}
      </div>
    </div>
    </Link>
