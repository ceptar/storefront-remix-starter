import React, { MouseEvent as ReactMouseEvent, useRef, useState, useEffect } from "react";
...
export default function Carousel({ featuredProducts }) {
  ...
  const handleDragSnap = (_: MouseEvent, { offset: { x: offsetX }, velocity: { x: velocityX } }: PanInfo) => {
