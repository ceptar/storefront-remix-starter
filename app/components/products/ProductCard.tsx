...
export function ProductCard({
  ...
  return (
    <Link className="flex flex-col bg-gray-100 shadow-md p-4" prefetch="intent" to={`/products/${slug}`}>
      ...
      />
      <div className="h-2" />
      <div className="text-sm text-gray-700 whitespace-nowrap overflow-hidden">{productName}</div>
