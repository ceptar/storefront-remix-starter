...
<header
  ...
  style={{
    ...
    borderColor: `rgba(${255 * (1 - headerOpacity - rootRouteOpacity)}, ${255 * (1 - headerOpacity - rootRouteOpacity)}, ${255 * (1 - headerOpacity - rootRouteOpacity)})`, // Interpolates from white to black
...
>
        ...
        <div className="relative px-4 flex flex-row items-center justify-between h-full w-full ">
          <div className="relative  flex flex-col  items-start justify-start w-1/6">
            ...
            >
              <Cart className="w-8 h-8 z-40" fill={`rgba(${255 * (1 - headerOpacity - rootRouteOpacity)}, ${255 * (1 - headerOpacity - rootRouteOpacity)}, ${255 * (1 - headerOpacity - rootRouteOpacity)})`}  />
              {cartQuantity ? (
          ...
          <div className="z-40 min-w-[100px] max-w-[300px] flex flex-col w-full justify-center mx-auto">
            <Link to="/" className="">
              <Logo className="max-h-12 mx-auto" fill={`rgba(${255 * (1 - headerOpacity - rootRouteOpacity)}, ${255 * (1 - headerOpacity - rootRouteOpacity)}, ${255 * (1 - headerOpacity - rootRouteOpacity)})`} />
            </Link>
          </div>
          <div className="z-40 flex flex-col items-end justify-center w-1/6">
            <Sliderex finalOpacity={`rgba(${255 * (1 - headerOpacity - rootRouteOpacity)}, ${255 * (1 - headerOpacity - rootRouteOpacity)}, ${255 * (1 - headerOpacity - rootRouteOpacity)})`} />
          </div>
        </div>
      </header>
  );
