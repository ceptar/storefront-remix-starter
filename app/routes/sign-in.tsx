                ...
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      autoComplete="email"
                      required
                      defaultValue="laugh.love@dance.more"
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <input
                      ...
                      name="rememberMe"
                      type="checkbox"
                      className="h-4 w-4 text-primary-500 focus:ring-primary-500 border-gray-300 disabled:bg-gray-300 disabled:cursor-not-allowed"
                      defaultChecked
                    />
                    <label
                      htmlFor="rememberMe"
